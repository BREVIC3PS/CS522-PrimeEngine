...
// sent by movement state machine when a soldier has to walk
struct SoldierNPCAnimSM_Event_AIM : public PE::Events::Event {
	PE_DECLARE_CLASS(SoldierNPCAnimSM_Event_AIM);

	SoldierNPCAnimSM_Event_AIM() {}
};
...
struct SoldierNPCAnimationSM : public PE::Components::DefaultAnimationSM
{
	...
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SoldierNPCAnimSM_Event_AIM)
	virtual void do_SoldierNPCAnimSM_Event_AIM(PE::Events::Event* pEvt);
