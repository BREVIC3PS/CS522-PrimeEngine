...
void CameraSceneNode::do_CALCULATE_TRANSFORMATIONS(Events::Event *pEvt)
{
	...
	m_smallerViewToProjectedTransform = CameraOps::CreateProjectionMatrix(smallerVerticalFov,
		aspect,
		m_near, m_far);
	...
	m_smallerFrustum = CreateSmallerFrustum(m_viewToProjectedTransform * m_worldToViewTransform, 0.5);
